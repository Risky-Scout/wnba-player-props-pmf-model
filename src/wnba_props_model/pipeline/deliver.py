...
def write_delivery(pmfs: pd.DataFrame, out_dir: str | Path, raw_props: pd.DataFrame | None = None) -> dict[str, Path]:
    out = Path(out_dir)
    ...
    paths = {"full_pmfs_wide": full_path, "fair_odds_board": board_path}
