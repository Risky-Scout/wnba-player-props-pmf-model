...
# Combo correlations — defaults aligned with bivariate_pmf.py theory-grounded values.
# Single source of truth: artifacts/models/stage4_baseline/combo_correlations_by_pos.json
# (generated by compute_combo_correlations_by_pos.py and train_baseline_pmfs.py).
# Fallback file: config/model/combo_correlations.json (manually curated override).
_COMBO_CORRELATIONS: dict[str, float] = {
    "pts_reb":     0.08,   # aligned with bivariate_pmf._DEFAULT_CORRELATIONS
    "pts_ast":    -0.12,   # aligned with bivariate_pmf._DEFAULT_CORRELATIONS
    "reb_ast":    -0.05,   # aligned with bivariate_pmf._DEFAULT_CORRELATIONS
    "pts_reb_ast": -0.08,  # aligned with bivariate_pmf._DEFAULT_CORRELATIONS
    "stocks":      0.12,   # aligned with bivariate_pmf._DEFAULT_CORRELATIONS
}
